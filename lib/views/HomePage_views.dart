    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("25-30 Kasım Kampanyası!", style: AppTypography.bodySmall),
          SizedBox(height: AppSpacing.md),
          SizedBox(
            height: 220,
            child: ListView(
        ...
        children: [
              ...
              if (discount != null)
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text("%$discount", style: AppTypography.discountBadge),
                  ),
                ),
              if (isNew && discount == null)
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text("YENİ", style: AppTypography.discountBadge),
                  ),
                ),
              Positioned(
                top: AppSpacing.sm,
                ...
                child: Container(
                  ...
                  child: Icon(Icons.favorite_border, size: AppSizes.iconXS, color: AppColors.textTertiary),
                ),
              ),
            ],
          ),
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, maxLines: 1, overflow: TextOverflow.ellipsis, style: AppTypography.labelMedium),
                Text(weight, style: AppTypography.bodySmall),
                SizedBox(height: AppSpacing.xs),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Column(
                      ...
                      children: [
                        if (oldPrice != null)
                          Text("₺${oldPrice.toStringAsFixed(2)}", style: AppTypography.priceOld),
                        Text("₺${price.toStringAsFixed(2)}", style: AppTypography.priceMain),
                      ],
                    ),
                    Container(
                      width: 28,
                      ...
                      child: Icon(Icons.add, color: AppColors.textOnPrimary, size: AppSizes.iconXS),
                    ),
                  ],
                ),
              ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: AppSpacing.xs),
          Text("En son eklenen ürünlerimiz", style: AppTypography.bodySmall),
          SizedBox(height: AppSpacing.md),
          SizedBox(
            height: 220,
            child: ListView(
